...
Blockly.Python['colour_convert'] = function (block) {
  // Convert colour to RGB array.
  var colour = Blockly.Python.valueToCode(block, 'COLOUR', Blockly.Python.ORDER_NONE || '\'#000000\'');
  var r = parseInt(colour.substr(2, 2), 16);
  var g = parseInt(colour.substr(4, 2), 16);
  var b = parseInt(colour.substr(6, 2), 16);
  var code = '[' + r + ', ' + g + ', ' + b + ']';
  return [code, Blockly.Python.ORDER_ATOMIC];
};