...
Blockly.Python['lists_extend'] = function (block) {
  // Block for extending a list.
  var list1 = Blockly.Python.valueToCode(block, 'LIST1', Blockly.Python.ORDER_NONE || '[]');
  var list2 = Blockly.Python.valueToCode(block, 'LIST2', Blockly.Python.ORDER_NONE || '[]');
  var code = list1 + '.extend(' + list2 + ')\n';
  return code;
};
