...
Blockly.alert = function (message, callback) {
  CustomDialog.show(MSG['alert'], message, {
    onCancel: callback
  });
};
...
Blockly.confirm = function (message, callback) {
  CustomDialog.show(MSG['confirm'], message, {
    showOkay: true,
    onOkay: function () {
      callback(true);
    },
...
Blockly.prompt = function (message, defaultValue, callback) {
  CustomDialog.show(MSG['prompt'], message, {
    showInput: true,
    showOkay: true,
    onOkay: function () {
...
CustomDialog.show = function (title, message, options) {
  ...
  if (options.showOkay) {
    ...
    document.getElementById('customDialogOkay').textContent = Blockly.Msg["IOS_OK"];
  }
